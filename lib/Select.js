...
var Select = function (_React$Component) {
  ...
  function Select(props) {
    ...
    var initialValue = _this.props.model[_this.props.form.key] || (_this.props.form.titleMap != null ? _this.props.form.titleMap[0].value : "");

    _this.state = {
      currentValue: initialValue
    };

    var mockEvent = { target: { value: initialValue } };

    _this.props.onChangeValidate(mockEvent);
    return _this;
  }
  ...
  _createClass(Select, [{
    ...
    value: function render() {
      var menuItems = this.props.form.titleMap.map(function (item, idx) {
        return _react2.default.createElement(_MenuItem2.default, { key: idx, primaryText: item.name, value: item.value });
      });
